...
public class CliOptions
{
    ...
    private static Option problemNumberOption() {
        return Option.builder()
                .option("p")
                .longOpt("problem")
                .desc("The problem to be executed in yy:dd or yyyy:dd format. If omitted, all problems will be solved")
                .hasArg()
                .type(String.class)
                .build();
    }
    ...
    private static Option problemOtherNumberOption() {
        return Option.builder()
                ...
                .desc("A second problem to be executed in yy:dd or yyyy:dd format. All problems between -p and -pb will be executed (inclusive)")
                .hasArg()
                .type(String.class)
                .build();
    }
