...
public class PointRectangleTest {
    ...
    public void testOverlappingRegions(
            final Pair<Pair<PointRectangle, PointRectangle>, Optional<PointRectangle>> rectanglesAndOverlap) {
        final Pair<PointRectangle, PointRectangle> rectangles = rectanglesAndOverlap.getLeft();
        final Optional<PointRectangle> overlap =
                PointRectangle.getOverlappingRegion(rectangles.getLeft(), rectangles.getRight());
    ...
    public void testCompliment(
            final Pair<Pair<PointRectangle, PointRectangle>, Set<PointRectangle>> rectanglesAndCompliment) {
    ...
    public static Set<Pair<Pair<PointRectangle, PointRectangle>, Optional<PointRectangle>>> getOverlappingWithRegions() {
        return Set.of(Pair.of(Pair.of(new PointRectangle(0, 0, 2, 2), new PointRectangle(1, 1, 2, 2)),
                        Optional.of(new PointRectangle(1, 1, 1, 1))),
                Pair.of(Pair.of(new PointRectangle(0, 0, 2, 2), new PointRectangle(2, 2, 2, 2)),
                        Optional.of(new PointRectangle(2, 2, 0, 0))),
                Pair.of(Pair.of(new PointRectangle(0, 0, 3, 1), new PointRectangle(1, -1, 1, 3)),
                        Optional.of(new PointRectangle(1, 0, 1, 1))));
    }

    public static Set<Pair<Pair<PointRectangle, PointRectangle>, Set<PointRectangle>>> getOverlappingWithCompliment() {
        return Set.of(Pair.of(Pair.of(new PointRectangle(0, 0, 2, 2), new PointRectangle(1, 1, 2, 2)),
                        Set.of(new PointRectangle(0, 0, 0, 0), new PointRectangle(0, 1, 0, 1), new PointRectangle(1,
                                0, 1, 0))),
                Pair.of(Pair.of(new PointRectangle(0, 0, 2, 2), new PointRectangle(2, 2, 2, 2)),
                        Set.of(new PointRectangle(0, 0, 1, 1), new PointRectangle(2, 0, 0, 1),
                                new PointRectangle(0, 2, 1, 0))),
                Pair.of(Pair.of(new PointRectangle(0, 0, 3, 1), new PointRectangle(1, -1, 1, 3)),
                        Set.of(new PointRectangle(0, 0, 0, 1), new PointRectangle(3, 0, 0, 1))),
                Pair.of(Pair.of(new PointRectangle(0, 0, 5, 5), new PointRectangle(2, 2, 1, 1)),
                        Set.of(new PointRectangle(0, 0, 1, 1), new PointRectangle(2, 0, 1, 1),
                                new PointRectangle(4, 0, 1, 1), new PointRectangle(0, 2, 1, 1),
                                new PointRectangle(0, 4, 1, 1), new PointRectangle(2, 4, 1, 1),
                                new PointRectangle(4, 2, 1, 1), new PointRectangle(4, 4, 1, 1))));
    }

    public static Set<Pair<PointRectangle, PointRectangle>> getOverlappingRectangles() {
        return Set.of(Pair.of(new PointRectangle(0, 0, 2, 2), new PointRectangle(1, 1, 2, 2)),
    ...
    public static Set<Pair<PointRectangle, PointRectangle>> getNonOverlappingRectangles() {
        return Set.of(Pair.of(new PointRectangle(0, 0, 2, 2), new PointRectangle(2, 3, 2, 2)));
    }
