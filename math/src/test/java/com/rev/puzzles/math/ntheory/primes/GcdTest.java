...
class GcdTest {
    ...
    @Test
    void testGcds() {
        Assertions.assertAll(() -> assertEquals(2, gcd(4, 2)), () -> assertEquals(1, gcd(11, 3)),
                () -> assertEquals(3, gcd(15, 21)), () -> assertEquals(10, gcd(100, 1010)),
                () -> assertEquals(17, gcd(17, 17)), () -> assertEquals(1, gcd(2, 1)));
    }
