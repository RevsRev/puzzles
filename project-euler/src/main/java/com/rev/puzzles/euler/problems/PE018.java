...
public final class PE018 {

    @PeProblem(number = 18)
    @PeTestData(inputs = {"3", "7 4", "2 4 6", "8 5 9 3"}, solutions = {"23"})
    public long maxPathSumPartOne(final ProblemResourceLoader<List<String>> inputs) {
        return maxPathSumPartOne(inputs.resources());
    }

    private long maxPathSumPartOne(final List<String> triangleLines) {
