...
public final class LeetResultColumnFormatterError extends ResultColumnFormatter<LeetCoordinate> {
    public LeetResultColumnFormatterError(final String header, final int width, final char padChar) {
