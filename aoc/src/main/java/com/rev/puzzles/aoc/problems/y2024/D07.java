...
public final class D07 {
    ...
    private boolean canCreateEquation(final long target, long result, int index, final long[] inputs,
    ...
    private long[][] loadTargetAndInputs(final ProblemResourceLoader<List<String>> resourceLoader) {
